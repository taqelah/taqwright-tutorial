  ...
  projects: [
    {
      ...
      use: {
        ...
        appium: {
          ...
          autoStartDevice: true, // boot/attach the emulator — required by device.autoDiscover above
          //   (with autoDiscover off, this cold-boots the OFFLINE AVD named in device.name)
