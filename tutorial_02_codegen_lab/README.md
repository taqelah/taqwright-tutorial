...
[`../tutorial_11_page_object_lab/`](../tutorial_11_page_object_lab/) builds by hand) and run the generated spec.

## Prerequisites

Same as [`../tutorial_01_setup_lab/`](../tutorial_01_setup_lab/README.md): **Node 24+**, a booted Android emulator, and the
shared APK at `../app/DemoApp-v1.0.0.apk`.

```bash
cd tutorial_02_codegen_lab
...
> [`../tutorial_12_cloud_debug_lab/`](../tutorial_12_cloud_debug_lab/).
