...
[`../config-lab/`](../config-lab/), [`../annotations-lab/`](../annotations-lab/)).
...
Environment green? Work through the per-topic labs — e.g. [`../config-lab/`](../config-lab/)
(tune the run), [`../annotations-lab/`](../annotations-lab/), [`../parameterize-lab/`](../parameterize-lab/),
[`../parallel-lab/`](../parallel-lab/).
